...
import 'package:news_app/user_profil/profile.dart';
        ...
        builder: (hc) {
          return Scaffold(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            padding:
                                EdgeInsets.only(right: 260.0, bottom: 10.0),
                            child: Text(
                              "Categories",
                              style: TextStyle(
                                  color: hc.isSwitch
            ...
            bottomNavigationBar: FloatingNavbar(
              backgroundColor:
                  hc.isSwitch ? const Color(0xffffcdd2) : Colors.black54,
              onTap: (int val) {
                hc.bottomSelect(val);
